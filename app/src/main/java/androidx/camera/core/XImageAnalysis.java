...
import org.netvirta.thecamerax.YuvToRgbSurfaceConversion;
...
public final class XImageAnalysis extends UseCase {
    ...
    protected Map<String, Size> onSuggestedResolutionUpdated(
        ...
        YuvToRgbSurfaceConversion mConversionScript = new YuvToRgbSurfaceConversion(renderScript, new Size(resolution.getWidth(), resolution.getHeight()));
        Surface iSurface = mImageReader.getSurface();
